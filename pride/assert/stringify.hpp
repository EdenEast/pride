...
namespace pride { namespace assert { namespace impl
{
    ...
    struct compare_eq_t { template <class TL, class TR> bool operator()(const TL& lhs, const TR& rhs) const { return lhs == rhs; } };
    struct compare_ne_t { template <class TL, class TR> bool operator()(const TL& lhs, const TR& rhs) const { return lhs != rhs; } };
    struct compare_lt_t { template <class TL, class TR> bool operator()(const TL& lhs, const TR& rhs) const { return lhs <  rhs; } };
    struct compare_le_t { template <class TL, class TR> bool operator()(const TL& lhs, const TR& rhs) const { return lhs <= rhs; } };
    struct compare_gt_t { template <class TL, class TR> bool operator()(const TL& lhs, const TR& rhs) const { return lhs >  rhs; } };
    struct compare_ge_t { template <class TL, class TR> bool operator()(const TL& lhs, const TR& rhs) const { return lhs >= rhs; } };


    template <> struct string_maker<compare_eq_t> : string_maker_op_t { virtual const char* str() const noexcept override { return "=="; } };
    template <> struct string_maker<compare_ne_t> : string_maker_op_t { virtual const char* str() const noexcept override { return "!="; } };
    template <> struct string_maker<compare_lt_t> : string_maker_op_t { virtual const char* str() const noexcept override { return "<";  } };
    template <> struct string_maker<compare_le_t> : string_maker_op_t { virtual const char* str() const noexcept override { return "<="; } };
    template <> struct string_maker<compare_gt_t> : string_maker_op_t { virtual const char* str() const noexcept override { return ">";  } };
    template <> struct string_maker<compare_ge_t> : string_maker_op_t { virtual const char* str() const noexcept override { return ">="; } };
