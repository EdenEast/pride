...
namespace pride { namespace assert { namespace detail
{
    ...
    public:
        ...
        template <typename R> int operator&  (const R&) { static_assert(tfalse<R>::value, "Expression too complex: rewrite as binary comparison"); return int(); }
        template <typename R> int operator^  (const R&) { static_assert(tfalse<R>::value, "Expression too complex: rewrite as binary comparison"); return int(); }
        template <typename R> int operator|  (const R&) { static_assert(tfalse<R>::value, "Expression too complex: rewrite as binary comparison"); return int(); }
        template <typename R> int operator&& (const R&) { static_assert(tfalse<R>::value, "Expression too complex: rewrite as binary comparison"); return int(); }
        template <typename R> int operator|| (const R&) { static_assert(tfalse<R>::value, "Expression too complex: rewrite as binary comparison"); return int(); }
    ...
    public:
        ...
        template <typename R> friend bool_expression_t operator==(expression_lhs<Type> lhs, R&& rhs) { return bool_expression_t(std::move(lhs.value), compare_eq_t(), std::forward<R>(rhs)); }
        template <typename R> friend bool_expression_t operator!=(expression_lhs<Type> lhs, R&& rhs) { return bool_expression_t(std::move(lhs.value), compare_ne_t(), std::forward<R>(rhs)); }
        template <typename R> friend bool_expression_t operator< (expression_lhs<Type> lhs, R&& rhs) { return bool_expression_t(std::move(lhs.value), compare_lt_t(), std::forward<R>(rhs)); }
        template <typename R> friend bool_expression_t operator<=(expression_lhs<Type> lhs, R&& rhs) { return bool_expression_t(std::move(lhs.value), compare_le_t(), std::forward<R>(rhs)); }
        template <typename R> friend bool_expression_t operator> (expression_lhs<Type> lhs, R&& rhs) { return bool_expression_t(std::move(lhs.value), compare_gt_t(), std::forward<R>(rhs)); }
        template <typename R> friend bool_expression_t operator>=(expression_lhs<Type> lhs, R&& rhs) { return bool_expression_t(std::move(lhs.value), compare_ge_t(), std::forward<R>(rhs)); }
