...
namespace internal
{
    namespace sevarity
    {
        static constexpr std::array<const char*, 7> long_names{ { "trace", "debug", "info", "warn", "error", "crit", "off" } };

        static constexpr std::array<const char*, 7> short_names{ { "T", "D", "I", "W", "E", "C", "O" } };
