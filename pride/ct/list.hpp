...
namespace list
{
    ...
    namespace internal
    {
        ...
        {
            static_assert(!(Index + 1), "Out of range access in get_type");
        };
    ...
    namespace internal
    {
        ...
        struct prepend<Type<Others...>, Types...>
        {
            using type = Type<Types..., Others...>;
        };
        template<template<typename...> class Type, typename... Others, typename... Types>
        struct append<Type<Others...>, Types...>
        {
    ...
    namespace internal
    {
        ...
        struct remove<List, Index, Current, Types...> : public remove<append_if<Index != 0, List, Current>, Index - 1, Types...>
        {};
        ...
        struct remove_if<List, Pred, ExpectedResult, Current, Types...> : public remove_if<append_if<Pred<Current>::value != ExpectedResult, List, Current>, Pred, ExpectedResult, Types...>
        {};
    ...
    namespace internal
    {
        ...
        struct for_each<List<Types...>, Pred>
        {
