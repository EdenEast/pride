...
namespace internal::xxhash
{
    ...
    {
        constexpr static std::array<uint32_t, 5> primes{ { 2654435761U, 2246822519U, 3266489917U, 668265263U, 374761393U } };
    ...
    {
        constexpr static std::array<uint64_t, 5> primes{ { 11400714785074694791ULL, 14029467366897019727ULL, 1609587929392839161ULL, 9650029242287828579ULL, 2870177450012600261ULL } };
